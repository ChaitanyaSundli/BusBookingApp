// lib/core/features/booking/data/models/booking_detail.dart
...
class BoardingStop {
  ...
  factory BoardingStop.fromJson(Map<String, dynamic> json) => _$BoardingStopFromJson(json);
...
class DetailedBookingSeat {
  ...
  factory DetailedBookingSeat.fromJson(Map<String, dynamic> json) => _$DetailedBookingSeatFromJson(json);
...
class Seat {
  ...
  Seat({required this.seatNumber, required this.seatType, required this.deck});
